    ...
    <div>
      <div className='flex justify-between md:items-center flex-col md:flex-row'>
        ...
        <div className='flex items-center mt-3 md:mt-0 md:justify-end gap-3 '>
          ...
          <select className=" select-sm glass opacity-[.8] rounded-md text-white max-w-xs" value={season} onChange={handleSeasonChange}>
      ...
      </div>
      {
        ...
        ) : <div className='h-[50vh] text-error text-2xl flex items-center justify-center'>No Anime Available :(</div>
      }
      {
        seasons ? (
