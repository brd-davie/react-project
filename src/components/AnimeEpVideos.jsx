            ...
            <div className="grid grid-cols-2 md:grid-cols-3 w-full mt-5 lg:h-[600px] lg:block lg:overflow-scroll scroll-smooth lg:w-3/12 lg:pr-3">
              {video.map((anime, index) => (
                <div
                  ...
                  className="anime-list-card lg:mb-3 cursor-pointer relative"
                >
                  <h1 className="text-white no-underline lg:text-lg underline bg-slate-900 px-3 hidden absolute bottom-1 left-3 lg:block">
                    {anime.title}
                  </h1>
                  <img
