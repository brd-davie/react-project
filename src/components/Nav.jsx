...
const Nav = () => {
  return (
    <div className='relative'>
      <div id='custom-navigation' className="nav w-full bg-black fixed z-[100]">
        <div className="navbar flex-none gap-3 relative bg-black max-w-7xl mx-auto pl-2 flex-row md:flex-row justify-between relative ">
          <div className="navbar-end justify-start">
            ...
            <div className="dropdown md:hidden w-screen">
              ...
              <ul tabIndex={0} id='menu-dropdown' className="menu menu-compact dropdown-content mt-4 p-4 shadow text-white bg-black w-screen">
                <li><Link to='/anime/search' className='text-center text-lg'>Search</Link></li>
          ...
          <ul className='hidden md:flex menu menu-horizontal w-full flex-wrap md:flex-nowrap justify-end p-0  flex-end h-full'>
            ...
            <li className='h-full'><Link to='/anime/genre' className='flex items-center text-white hover:text-primary hover:underline bg-black px-4 text-white h-full'>Genres</Link></li>
            <li className='h-full'><Link to='/anime/trending-anime' className='flex items-center text-white hover:text-primary hover:underline bg-black px-4 text-white h-full'>Trending</Link></li>
            <li className='h-full'><Link to='/anime/character-list' className='flex items-center text-white hover:text-primary hover:underline bg-black px-4 text-white h-full'>Top Characters</Link></li>
            <Profile />
          </ul>
