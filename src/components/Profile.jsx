...
const Profile = () => {
  ...
  return (
    <div className="dropdown dropdown-end flex">
      <label tabIndex={0} className="bg-black px-2 cursor-pointer">
        <svg fill="#ffffff" width="27px" height="27px" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg">
      ...
      <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-black mt-10 rounded-box w-30">
        <li>
          <Link to='/profile' className='text-white opacity-[.6] bg-black hover:underline'>Profile</Link>
        </li>
        <li>
          <Link to='/login' className='text-white opacity-[.6] hover:underline' onClick={handleLogout}>Logout
