...
const Profile = () => {
  ...
  return (
    <div className="dropdown dropdown-end flex">
      <label tabIndex={0} className="cursor-pointer opacity-[0.8] flex items-center hover:opacity-[unset]">
          <MyAvatar />
      ...
      <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-[#5DB4AD] mt-14 rounded-box w-30">
        <li>
          <Link to='/profile' className='text-white hover:underline hover:opacity-[unset] active:bg-[#5DB4AD]'>Profile
        ...
        <li>
          <Link to='/login' className='text-white hover:underline hover:opacity-[unset] active:bg-[#5DB4AD]' onClick={handleLogout}>Logout
