      ...
      <div id="anime" className="pt-0 md:pt-8">
        <div className="anime-wrapper md:flex md:flex-col lg:flex-row">
          ...
          <div className="text-md text-justify leading-12 w-full px-4">
            <h2 className='bb-anime-details text-white opacity-[.6] mt-4 md:mt-0 text-2xl pb-3 pb-0'>{anime.title ? anime.title : 'N/A'}</h2>
            <div className='bb-anime-details flex justify-between p-2'>
              <p className="text-lg font-bold text-white opacity-[.6]"><strong className='opacity-[.3]'>Rank:</strong> {anime.rank ? anime.rank : 'N/A'}</p>
            ...
            <div className=''>
              ...
              <p className="bb-anime-details text-md text-white opacity-[.6] p-2"><strong className='text-white opacity-[.3]'>Status:</strong> {anime.status}</p>
              ...
              <p className="bb-anime-details my-2 text-md text-white opacity-[.6] p-2"><strong className='text-white opacity-[.3]'>Number of Episodes: </strong> {anime.episodes}</p>
            </div>
